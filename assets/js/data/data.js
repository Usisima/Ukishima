...
const OPTATIVAS_BLOQUE_I = [
  { name: "Álgebra Geométrica",                            clave: "0014", creditos: 10, icon: "assets/images/d17.jpg", colorIdx: 8  },
  { name: "Conjuntos Convexos",                            clave: "0088", creditos: 10, icon: "assets/images/d19.jpg", colorIdx: 8  },
  { name: "Conjuntos y Lógica",                            clave: "0271", creditos: 10, icon: "assets/images/d20.jpg", colorIdx: 0  },
  { name: "Diseño de Sistemas Digitales",                  clave: "0574", creditos: 10, icon: "assets/images/d21.jpg", colorIdx: 5  },
  { name: "Electromagnetismo I",                           clave: "0419", creditos: 12, icon: "assets/images/d22.jpg", colorIdx: 7  },
  { name: "Fenómenos Colectivos",                          clave: "0302", creditos: 12, icon: "assets/images/d1.jpg", colorIdx: 6  },
  { name: "Geometría Moderna II",                          clave: "0250", creditos: 10, icon: "assets/images/d24.jpg", colorIdx: 7  },
  { name: "Geometría Proyectiva",                          clave: "0251", creditos: 10, icon: "assets/images/d25.jpg", colorIdx: 8  },
  { name: "Gráficas y Juegos",                             clave: "0422", creditos: 10, icon: "assets/images/d26.jpg", colorIdx: 10 },
  { name: "Introducción a Ciencias de la Computación I",   clave: "0224", creditos: 10, icon: "assets/images/d27.jpg", colorIdx: 8  },
  { name: "Introducción a Ciencias de la Computación II",  clave: "0339", creditos: 10, icon: "assets/images/d28.jpg", colorIdx: 2  },
  { name: "Introducción a la Geometría Avanzada",          clave: "0272", creditos: 10, icon: "assets/images/d29.jpg", colorIdx: 1  },
  { name: "Matemáticas Discretas",                         clave: "0416", creditos: 10, icon: "assets/images/d5.jpg", colorIdx: 1  },
  { name: "Mecánica Vectorial",                            clave: "0228", creditos: 10, icon: "assets/images/d31.jpg", colorIdx: 8  },
  { name: "Probabilidad I",                                clave: "0625", creditos: 10, icon: "assets/images/d10.jpg", colorIdx: 2  },
  { name: "Teoría de los Números I",                       clave: "0764", creditos: 10, icon: "assets/images/d33.jpg", colorIdx: 0  },
  { name: "Teoría de los Números II",                      clave: "0777", creditos: 10, icon: "assets/images/d34.jpg", colorIdx: 8  },
];

// Bloque II — Semestres 5 y 6 (40 créditos)
const OPTATIVAS_BLOQUE_II = [
  { name: "Álgebra Moderna II",                            clave: "0002", creditos: 10, icon: "assets/images/d35.jpg", colorIdx: 0  },
  { name: "Análisis de Algoritmos I",                      clave: "0414", creditos: 10, icon: "assets/images/d36.jpg", colorIdx: 9  },
  { name: "Análisis Numérico",                             clave: "1710", creditos: 10, icon: "assets/images/d16.jpg", colorIdx: 5  },
  { name: "Arquitectura de Computadoras",                  clave: "0605", creditos: 10, icon: "assets/images/d3.jpg", colorIdx: 4  },
  { name: "Cálculo de las Variaciones",                    clave: "0083", creditos: 10, icon: "assets/images/d39.jpg", colorIdx: 7  },
  { name: "Economía I",                                    clave: "1609", creditos: 10, icon: "assets/images/d41.jpg", colorIdx: 5  },
  { name: "Ecuaciones Diferenciales II",                   clave: "0163", creditos: 10, icon: "assets/images/d6.jpg", colorIdx: 0  },
  { name: "Electromagnetismo II",                          clave: "0609", creditos: 10, icon: "assets/images/d59.jpg", colorIdx: 0  },
  { name: "Estadística I",                                 clave: "0398", creditos: 10, icon: "assets/images/d44.jpg", colorIdx: 10 },
  { name: "Estadística II",                                clave: "0399", creditos: 10, icon: "assets/images/d11.jpg", colorIdx: 2  },
  { name: "Geometría Diferencial I",                       clave: "0246", creditos: 10, icon: "assets/images/d12.jpg", colorIdx: 1  },
  { name: "Geometría Diferencial II",                      clave: "0247", creditos: 10, icon: "assets/images/d9.jpg", colorIdx: 4  },
  { name: "Historia de las Matemáticas I",                 clave: "0286", creditos: 10, icon: "assets/images/d13.jpg", colorIdx: 10 },
  { name: "Historia de las Matemáticas II",                clave: "0287", creditos: 10, icon: "assets/images/d49.jpg", colorIdx: 8  },
  { name: "Introducción a la Física Cuántica",             clave: "0582", creditos: 10, icon: "assets/images/d50.jpg", colorIdx: 8  },
  { name: "Introducción Matemática a la Mecánica Celeste", clave: "0356", creditos: 10, icon: "assets/images/d52.jpg", colorIdx: 8  },
  { name: "Investigación de Operaciones",                  clave: "1506", creditos: 10, icon: "assets/images/d53.jpg", colorIdx: 8  },
  { name: "Lenguajes de Programación y sus Paradigmas",    clave: "0607", creditos: 10, icon: "assets/images/d55.jpg", colorIdx: 1  },
  { name: "Lógica Matemática I",                           clave: "0445", creditos: 10, icon: "assets/images/d56.jpg", colorIdx: 8  },
  { name: "Matemáticas Avanzadas de la Física",            clave: "0610", creditos: 10, icon: "assets/images/d57.jpg", colorIdx: 7  },
  { name: "Mecánica Analítica",                            clave: "0611", creditos: 10, icon: "assets/images/d58.jpg", colorIdx: 10 },
  { name: "Muestreo",                                      clave: "0891", creditos: 10, icon: "assets/images/d14.jpg", colorIdx: 2  },
  { name: "Óptica",                                        clave: "0584", creditos: 10, icon: "assets/images/d60.jpg", colorIdx: 2  },
  { name: "Probabilidad II",                               clave: "0626", creditos: 10, icon: "assets/images/d61.jpg", colorIdx: 8  },
...
const OPTATIVAS_BLOQUE_III = [
  ...
  { name: "Complejidad Computacional",                               clave: "—",    creditos: 10, icon: "assets/images/d40.jpg" },
...
const OPTATIVAS_OTRAS = [
  { name: "Administración de Sistemas de Cómputo",               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Algoritmos Genéticos",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis de Fourier III",                              clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis de Redes",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis Lógico",                                      clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis Multivariado",                                clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis Numérico I",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Análisis Numérico II",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Arquitectura de Máquinas",                             clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Astrofísica General I",                                clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Astronomía General",                                   clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Astronomía General I",                                 clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Astronomía General II",                                clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Autómatas y Lenguajes Formales",                       clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Cálculo Tensorial",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Ciencia, Diversidad e Inclusión",                      clave: "—",    creditos: 8,  icon: "assets/images/d0.jpg" },
  { name: "Circuitos Digitales con Laboratorio",                  clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Computación I",                                        clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Computación II",                                       clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Didáctica de la Física",                               clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Didáctica de las Matemáticas",                         clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Didáctica General",                                    clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Dinámica no Lineal",                                   clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Diseño de Interfases",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Diseño Lógico I",                                      clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Diseño Lógico II",                                     clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Econometría",                                          clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Economía Matemática I",                                clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Economía Matemática II",                               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Ecuaciones Diferenciales III",                         clave: "—",    creditos: 10, icon: "assets/images/d87.jpg" },
  { name: "El Grupo de Lorentz",                                  clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Electrónica I",                                        clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Electrónica II",                                       clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Elementos de Teoría Electromagnética",                 clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Estructura de Computadoras",                           clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Estructura de Datos",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Filosofía de la Física",                               clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Física Clásica I — Mecánica",                          clave: "—",    creditos: 18, icon: "assets/images/d0.jpg" },
  { name: "Física Clásica II — Ondas, Fluidos y Calor",           clave: "—",    creditos: 15, icon: "assets/images/d0.jpg" },
  { name: "Física Clásica III — Óptica",                          clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Física Clásica IV — Electricidad",                     clave: "—",    creditos: 18, icon: "assets/images/d0.jpg" },
  { name: "Física General",                                       clave: "—",    creditos: 18, icon: "assets/images/d0.jpg" },
  { name: "Física Moderna I",                                     clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Física Moderna II",                                    clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Física Moderna III",                                   clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Física Teórica I — Mecánica",                          clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Física Teórica II — Termodinámica",                    clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Física Teórica III — Electromagnetismo",               clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Fotografía Científica",                                clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Funciones Especiales y Transformadas Integrales",      clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Género y Diversidades",                                clave: "—",    creditos: 8,  icon: "assets/images/d0.jpg" },
  { name: "Género, No Violencia y Comunidad Científica",          clave: "—",    creditos: 8,  icon: "assets/images/d0.jpg" },
  { name: "Género, Tecnociencia y Transformación",                clave: "—",    creditos: 8,  icon: "assets/images/d0.jpg" },
  { name: "Geometría Sumatoria II",                               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Graficación por Computadoras",                         clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Grandes Bases de Datos",                               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Historia de la Física I",                              clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Historia del México Contemporáneo",                    clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a la Física Atmosférica",                 clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a la Física Nuclear I",                   clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a la Geofísica",                          clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a la Relatividad",                        clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a la Teoría del Magnetismo",              clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Introducción a los Sistemas Complejos",                clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Introducción Crítica a Diplomacia y Ciencia",          clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "La Sustentabilidad del Desarrollo",                    clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Laboratorio de Teleproceso",                           clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Lenguajes de Programación I",                          clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Lenguajes de Programación II",                         clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Lingüística Computacional",                            clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Lógicas no Clásicas",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Matemáticas Finitas",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Máquinas Digitales con Laboratorio",                   clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Métodos de Programación",                              clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Métodos y Análisis de Sistemas",                       clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "México: Nación Multicultural",                         clave: "—",    creditos: 4,  icon: "assets/images/d0.jpg" },
  { name: "Oceanografía Física",                                  clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Origen de la Vida",                                    clave: "—",    creditos: 12, icon: "assets/images/d0.jpg" },
  { name: "Óptica Física I",                                      clave: "—",    creditos: 6,  icon: "assets/images/d0.jpg" },
  { name: "Proceso Digital de Imágenes",                          clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Procesos Paralelos y Distribuidos",                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Programación Avanzada",                                clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Programación de Sistemas",                             clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Robótica",                                             clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario: Aplicaciones de Cómputo",                   clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Cálculo de Formas Diferenciales",         clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Cibernética",                             clave: "—",    creditos: 9,  icon: "assets/images/d0.jpg" },
  { name: "Seminario de Cómputo A",                               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Cómputo B",                               clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Econometría",                             clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Sistemas A",                              clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Seminario de Sistemas B",                              clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Sistemas de Bases de Datos",                           clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Sistemas de Información",                              clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Sistemas Expertos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Sociología",                                           clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Tensores y Grupos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Teoría de Códigos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Teoría de Gráficas",                                   clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Teoría Matemática de la Computación",                  clave: "—",    creditos: 10, icon: "assets/images/d0.jpg" },
  { name: "Una Introducción con Perspectiva de Género a las Ciencias Exactas", clave: "—", creditos: 8, icon: "assets/images/d0.jpg" },
];

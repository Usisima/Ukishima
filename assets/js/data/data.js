...
const OPTATIVAS_OTRAS = [
  { name: "Administración de Sistemas de Cómputo",               clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Algoritmos Genéticos",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis de Fourier III",                              clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis de Redes",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis Lógico",                                      clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis Multivariado",                                clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis Numérico I",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Análisis Numérico II",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Arquitectura de Máquinas",                             clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Astrofísica General I",                                clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Astronomía General",                                   clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Astronomía General I",                                 clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Astronomía General II",                                clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Autómatas y Lenguajes Formales",                       clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Cálculo Tensorial",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Ciencia, Diversidad e Inclusión",                      clave: "—",    creditos: 8,  icon: "assets/images/d0.webp" },
  { name: "Circuitos Digitales con Laboratorio",                  clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Computación I",                                        clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Computación II",                                       clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Didáctica de la Física",                               clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Didáctica de las Matemáticas",                         clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Didáctica General",                                    clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Dinámica no Lineal",                                   clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Diseño de Interfases",                                 clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Diseño Lógico I",                                      clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Diseño Lógico II",                                     clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  ...
  { name: "Elementos de Teoría Electromagnética",                 clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Estructura de Computadoras",                           clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Estructura de Datos",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Filosofía de la Física",                               clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Física Clásica I — Mecánica",                          clave: "—",    creditos: 18, icon: "assets/images/d0.webp" },
  { name: "Física Clásica II — Ondas, Fluidos y Calor",           clave: "—",    creditos: 15, icon: "assets/images/d0.webp" },
  { name: "Física Clásica III — Óptica",                          clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Física Clásica IV — Electricidad",                     clave: "—",    creditos: 18, icon: "assets/images/d0.webp" },
  { name: "Física General",                                       clave: "—",    creditos: 18, icon: "assets/images/d0.webp" },
  { name: "Física Moderna I",                                     clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Física Moderna II",                                    clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Física Moderna III",                                   clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Física Teórica I — Mecánica",                          clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Física Teórica II — Termodinámica",                    clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Física Teórica III — Electromagnetismo",               clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Fotografía Científica",                                clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Funciones Especiales y Transformadas Integrales",      clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Género y Diversidades",                                clave: "—",    creditos: 8,  icon: "assets/images/d0.webp" },
  { name: "Género, No Violencia y Comunidad Científica",          clave: "—",    creditos: 8,  icon: "assets/images/d0.webp" },
  { name: "Género, Tecnociencia y Transformación",                clave: "—",    creditos: 8,  icon: "assets/images/d0.webp" },
  { name: "Geometría Sumatoria II",                               clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Graficación por Computadoras",                         clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Grandes Bases de Datos",                               clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Historia de la Física I",                              clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Historia del México Contemporáneo",                    clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Introducción a la Física Atmosférica",                 clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Introducción a la Física Nuclear I",                   clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Introducción a la Geofísica",                          clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Introducción a la Relatividad",                        clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Introducción a la Teoría del Magnetismo",              clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Introducción a los Sistemas Complejos",                clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Introducción Crítica a Diplomacia y Ciencia",          clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "La Sustentabilidad del Desarrollo",                    clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Laboratorio de Teleproceso",                           clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Lenguajes de Programación I",                          clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Lenguajes de Programación II",                         clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Lingüística Computacional",                            clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Lógicas no Clásicas",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Matemáticas Finitas",                                  clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Máquinas Digitales con Laboratorio",                   clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Métodos de Programación",                              clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Métodos y Análisis de Sistemas",                       clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "México: Nación Multicultural",                         clave: "—",    creditos: 4,  icon: "assets/images/d0.webp" },
  { name: "Oceanografía Física",                                  clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Origen de la Vida",                                    clave: "—",    creditos: 12, icon: "assets/images/d0.webp" },
  { name: "Óptica Física I",                                      clave: "—",    creditos: 6,  icon: "assets/images/d0.webp" },
  { name: "Proceso Digital de Imágenes",                          clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Procesos Paralelos y Distribuidos",                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Programación Avanzada",                                clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Programación de Sistemas",                             clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Robótica",                                             clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario: Aplicaciones de Cómputo",                   clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Cálculo de Formas Diferenciales",         clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Cibernética",                             clave: "—",    creditos: 9,  icon: "assets/images/d0.webp" },
  { name: "Seminario de Cómputo A",                               clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Cómputo B",                               clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Econometría",                             clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Sistemas A",                              clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Seminario de Sistemas B",                              clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Sistemas de Bases de Datos",                           clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Sistemas de Información",                              clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Sistemas Expertos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Sociología",                                           clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Tensores y Grupos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Teoría de Códigos",                                    clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Teoría de Gráficas",                                   clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Teoría Matemática de la Computación",                  clave: "—",    creditos: 10, icon: "assets/images/d0.webp" },
  { name: "Una Introducción con Perspectiva de Género a las Ciencias Exactas", clave: "—", creditos: 8, icon: "assets/images/d0.webp" },
];

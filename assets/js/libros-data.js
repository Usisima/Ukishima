        ...
        chapters: [
          {
            ...
            notes: [
              ...
              { type:"def", label:"Axioma 1", tex:"x + y = y + x, xy = yx", description:"leyes conmutativas", sourcePage:"p. 2" },
              { type:"def", label:"Axioma 2", tex:"x + (y + z) = (x + y) + z, x(yz) = (xy)z", description:"leyes asociativas", sourcePage:"p. 2" },
              ...
              { type:"teo", label:"Teorema 1.28", tex:"(x_1, x_2) + (0, 0) = (x_1, x_2), (x_1, x_2)(0, 0) = (0, 0), (x_1, x_2)(1, 0) = (x_1, x_2), (x_1, x_2) + (-x_1, -x_2) = (0, 0).", dem:"Las demostraciones son inmediatas a partir de las definiciones, lo mismo que en los teoremas 1.29, 1.30, 1.32 y 1.33. \\blacksquare", sourcePage:"p. 20" },
              ...
              { type:"def", label:"Definición 1.34", tex:"El número complejo (0,1) se representa por i \\text{ y se llama unidad imaginaria.", dem:null, sourcePage:"p. 22" },
              ...
              { type:"def", label:"Definición 1.46", tex:"Sea z = x + iy un número complejo no nulo. El único número real \\theta que satisface las condiciones x = |z| \\cos \\theta, y = |z| \\sin \\theta, -\\pi < \\theta \\leq +\\pi se llama el argumento principal de z, y se representa por \\theta = \\arg(z).", dem:null, sourcePage:"p. 26" },
              ...
              { type:"def", label:"Definición 1.58", tex:"Dado un número complejo z, definimos \\cos z = \\frac{e^{iz} + e^{-iz}}{2}, \\sin z = \\frac{e^{iz} - e^{-iz}}{2i}.", note:"Cuando z es real, estas igualdades concuerdan con la definición 1.40.", dem:null, sourcePage:"p. 30" },
              { type:"teo", label:"Teorema 1.59", tex:"Si z = x + iy, entonces tenemos \\cos z = \\cos x \\cosh y - i \\sin x \\sinh y, \\sin z = \\sin x \\cosh y + i \\cos x \\sinh y.", dem:"2 cos z = e^{iz} + e^{-iz} = e^{-y}(cos x + i sen x) + e^{y}(cos x - i sen x) = cos x(e^{y}+e^{-y}) - i sen x(e^{y}-e^{-y}) = 2 cos x cosh y - 2i sen x senh y. La demostración para sen z es análoga. \\blacksquare", sourcePage:"p. 30" },
              { type:"def", label:"Definición 1.60", tex:"Por sistema de los números complejos ampliado \\mathbf{C}^* entenderemos el plano complejo \\mathbf{C} junto con un símbolo \\infty que satisfaga las siguientes propiedades: a) Si z \\in \\mathbf{C}, entonces se tiene z + \\infty = z - \\infty = \\infty, z/\\infty = 0. b) Si z \\in \\mathbf{C}, pero z \\neq 0, entonces z(\\infty) = \\infty y z/0 = \\infty. c) \\infty + \\infty = (\\infty)(\\infty) = \\infty.", dem:null, sourcePage:"p. 30" },

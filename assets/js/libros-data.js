 ...
 chapters: [
          {
            ...
            notes: [
              ...
              { type:"teo", label:"Fórmulas de seno y coseno complejos", tex:"Si $z = x + iy$: $$\\cos z = \\cos x \\cosh y - i\\sin x \\sinh y,$$ $$\\sin z = \\sin x \\cosh y + i\\cos x \\sinh y.$$", dem:"$2\\cos z = e^{iz}+e^{-iz} = e^{-y+ix}+e^{y-ix} = \\cos x(e^y+e^{-y}) - i\\sin x(e^y-e^{-y}) = 2\\cos x\\cosh y - 2i\\sin x\\sinh y$. Análogamente para $\\sin z$. $\\blacksquare$", sourcePage:"p. 33" },
